...
* **stapeln** container toolchain: **cerro-torre** (build/sign), **selur** (IPC seal), **vordr** (runtime), **selur-compose** (orchestration) — with Wolfi/Distroless base images
...
├── infra/            # Container manifests (stapeln/cerro-torre)
