...
* Git, Deno 2.x, stapeln toolchain (cerro-torre, selur, vordr)
...
----
$ just health-check
✓ Bastion gateway: healthy
✓ oDNS proxy: responding
...
**Success!** You've deployed the full stack. 🎉
...
→ Check: RPC URL, private key, testnet ETH balance

**"oDNS not starting"**
→ Check: HPKE keys exist in `policy/runner/crypto/`
