...
(define metadata
  '((version . "0.1.0")
    ...
    (repo . "github.com/hyperpolymath/indieweb2-bastion")))
...
(define project-context
  '((name . "indieweb2-bastion")
    (tagline . "IndieWeb2 is a next-generation framework for building audit-grade, consent-aware, and provenance-rich web infrastructure.")
    (version . "0.1.0")
