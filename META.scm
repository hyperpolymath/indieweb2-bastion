...
(define-module (indieweb2-bastion meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "IndieWeb2 is a next-generation framework for building audit-grade, consent-aware, and provenance-rich web infrastructure.")
...
(define development-practices
  '((code-style
     (languages . ("Cap'n Proto" "Dockerfile" "JavaScript" "Just" "Motoko" "Nickel" "ReScript" "Scheme" "Shell" "Solidity" "Vyper"))
